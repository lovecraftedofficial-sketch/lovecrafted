...
const comeHereBabyConfig = {
  ...
  features: [
    ...
    "6 WhatsApp Request Actions (Hug, Chocolate, Love, Laugh, Sweet Message, Need You)",
  ...
  editableSchema: [
    ...
    // SECTION 6: TELL ME WHAT YOU NEED (WHATSAPP REQUEST ACTIONS)
    { key: "needsTitle", label: "Needs Section Title", type: "text", defaultValue: "Tell Me What You Need" },
    { key: "needsSubtitle", label: "Needs Section Subtitle", type: "text", defaultValue: "You don't even have to explain. Just pick one. ❤️" },
    ...
    { key: "reqHug", label: "WhatsApp Message for 'I Need a Hug'", type: "textarea", defaultValue: "Baby, I need my hug now 🥺🫂" },
    { key: "reqChocolate", label: "WhatsApp Message for 'I Want Chocolate'", type: "textarea", defaultValue: "Baby, emergency chocolate request please 🍫🥺❤️" },
    { key: "reqLove", label: "WhatsApp Message for 'I Need Some Love'", type: "textarea", defaultValue: "I need some extra love today 🥺❤️" },
    { key: "reqLaugh", label: "WhatsApp Message for 'Make Me Laugh'", type: "textarea", defaultValue: "Baby, make me laugh. I'm having a difficult day 😭😂" },
    { key: "reqSweet", label: "WhatsApp Message for 'Send Me Something Sweet'", type: "textarea", defaultValue: "Can you send me something sweet? I need a little reminder that I'm loved. 💌❤️" },
    { key: "reqNeedYou", label: "WhatsApp Message for 'I Need You'", type: "textarea", defaultValue: "I just need you right now. 🥺❤️" },
  ...
  demoData: {
    ...
    needsTitle: "Tell Me What You Need",
    needsSubtitle: "You don't even have to explain. Just pick one. ❤️",
    whatsappPhoneNumber: "919876543210",
    reqHug: "Baby, I need my hug now 🥺🫂",
    reqChocolate: "Baby, emergency chocolate request please 🍫🥺❤️",
    reqLove: "I need some extra love today 🥺❤️",
    reqLaugh: "Baby, make me laugh. I'm having a difficult day 😭😂",
    reqSweet: "Can you send me something sweet? I need a little reminder that I'm loved. 💌❤️",
    reqNeedYou: "I just need you right now. 🥺❤️",
