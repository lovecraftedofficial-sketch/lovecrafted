        ...
        <div className="max-w-2xl mx-auto">
          {!isOpen ? (
            ...
            >
              ...
              <div className="space-y-4 text-base sm:text-lg font-serif text-[#f8b3c3] leading-relaxed whitespace-pre-line font-light">
                {letterBody}
              </div>
